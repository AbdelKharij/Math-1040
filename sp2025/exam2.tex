...
\begin{document}
\begin{abstract}
Exam 2, covering Sections 8.1--8.5: properties of combinations and expected value,
choosing between permutations and combinations, Pascal's triangle, counting
supervillain teams, and a binomial distribution used to compute an expected prize.
\end{abstract}
\maketitle
...
If the sketches were only \emph{selected} and not ordered, the count would be $C(40,10)=847{,}660{,}528$. Ordering the
