...
\begin{document}
\begin{abstract}
The cumulative final: two-set Venn diagrams and conditional probability, the
subtraction game, counting role assignments with restrictions, saddle points, and
