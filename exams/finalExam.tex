...
\begin{problem}
It's nearly girl scout cookie season, and I need to choose which six of the eleven
varieties of girl scout cookies currently available I'm going to buy for my office.

\begin{prompt}
\textbf{(a)} How many different sets of six could I possibly select from among the
...
\begin{prompt}
\textbf{(b)} Two of the eleven available varieties are gluten-free. If I want
\emph{exactly one} of my chosen cookie varieties to be gluten-free, how many
...
\begin{prompt}
\textbf{(d)} If I choose six at random from among the eleven available cookie
